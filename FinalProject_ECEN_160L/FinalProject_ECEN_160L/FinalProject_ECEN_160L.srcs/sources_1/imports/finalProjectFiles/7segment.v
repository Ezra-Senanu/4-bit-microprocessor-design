...
// 
// Revision:
// Revision 1.0 by Shane Jensen, Joseph Hawker
// Additional Comments:
// 
//////////////////////////////////////////////////////////////////////////////////

module sevenSegment(
    input [7:0] char, //The ASCII character you wish to display
    input charWE,     //The Character Write Enable
    input clk,        //The slower clock used to clock in the Characters
    input clk100MHz,  //The 100MHz clock
    output wire [6:0] seg, //Used by this module to drive the 7 segments
    output reg [3:0] an,   //Used by this module to select the display column
    output wire dp         //Used by this module to display a decimal point
    );
    reg [31:0] data;
    reg [19:0] clkDiv;
    reg [7:0] segdp, digit;
